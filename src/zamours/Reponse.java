...
public class Reponse {
	...
	public void reponseQuizz(int numQuestion) {
		...
		case 2:
			...
			tabReponse[4][2] = "Les Z'amours, des questions idiotes mais il aime vous faire\nplaisir.";
			...
			tabReponse[5][2] = "Les Z'amours, des questions idiotes mais il aime vous faire\nplaisir.";
			...
			tabReponse[8][2] = "\"Tu arrêtes tout... Non mais c'est quoi ces manières de\nsauvage !\"";
			tabReponse[9][0] = "Il adore... \"Oh ma chérie, montre moi ton côté sauvage !\"";
			tabReponse[9][1] = "\"Toi, tu ne payes rien pour attendre !\"";
			tabReponse[9][2] = "Il arrête tout... \"Non mais c'est quoi ces manières de\nsauvage !\"";
			...
			tabReponse[12][0] = "\"Ne regarde pas le prix chérie, prends le caviar si tu en as\nenvie\".";
			tabReponse[12][1] = "\"Ne regarde pas le prix chérie, prends le Big Mac si tu en as\nenvie\".";
			tabReponse[12][2] = "\"Oups, j'ai encore oublié mon portefeuille\".";
			tabReponse[13][0] = "\"Ne regarde pas le prix chérie, prends le caviar si tu en as\nenvie\".";
			tabReponse[13][1] = "\"Ne regarde pas le prix chérie, prends le Big Mac si tu en as\nenvie\".";
			...
			tabReponse[16][0] = "\"Stresses pas chérie, s'ils ne sont pas content, ils ont qu'à\ndoubler !\"";
			tabReponse[16][1] = "\"Passe-moi le volant, je vais la démarrer moi !\"";
			tabReponse[16][2] = "\"Enfin bon sens, démarre ! Tu ne vois pas qu'on se donne en\nspectacle non !\"";
			tabReponse[17][0] = "\"Stresse pas chérie, s'ils ne sont pas content, ils ont qu'à\ndoubler !\"";
			tabReponse[17][1] = "\"Passe-moi le volant, je vais la démarrer moi !\"";
			tabReponse[17][2] = "\"Enfin bon sens, démarre ! Tu ne vois pas qu'on se donne en\nspectacle non !\"";
