...
public class Reponse {
	...
	public void reponseQuizz(int numQuestion) {
		...
		case 1:
			...
			tabReponse[5][0] = "Tu le regarde mettre tes sous-vêtements dans le bac à linge.";
			...
			tabReponse[6][1] = "Sa chemise préférée est pendue sur la poignée de la porte,\net le gâteau dans le frigo.";
			tabReponse[6][2] = "Subitement, il fait comme s'il tombait malade et se prépare\nà te dire qu'il ne pourra pas venir.";
			tabReponse[7][0] = "Heuresement qu'elle te l'as rappelé, sinon demain t'allais au\nbowling avec tes amis.";
			tabReponse[7][1] = "Tout est organisé, tu as acheté le dessert pour ne pas arriver\nles mains vides et tu as déjà préparé ta tenue pour demain.";
